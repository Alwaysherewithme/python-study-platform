    ...
    <Fragment>
        <Row noGutters className="page-header py-4">
            <Col>
                ...
                <div>使用open()函数打开文件。open() 函数有两个参数：文件名和模式。例如：f = open("demofile.txt")</div>
                ...
                <div>实例：</div>
                <div>假设我们有以下名为 file.txt 的文件，位于与 Python 相同的文件夹中：</div>
                <pre>
                    登鹳雀楼
                    白日依山尽，
                    黄河入海流。
        ...
        <Row noGutters className="page-header py-4">
            <Col md="12" className="form-group">
                <h3>小测试</h3>
                <form id="testForm">
                    <label htmlFor="feFirstName">1.  判断对错：二进制文件不能使用记事本程序打开（  ）。</label>
                    <p>
                        <div>
                    ...
                    <label htmlFor="feFirstName">2.  判断对错：使用普通文本编辑器软件也可正常查看二进制文件的内容（  ）。</label>
                    <p>
                        <div>
                    ...
                    <label htmlFor="feFirstName">3.  判断对错：以"a"模式打开的文件无法进行读操作（ ）。</label>
                    <p>
                        <div>
