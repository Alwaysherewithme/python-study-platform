    ...
    <Fragment>
        <Row className="page-header py-4">
            <Col>
                ...
                <div>显示结果：</div>
                <pre>
                    Please enter your name: Eric     # 粗体 Eric 为用户输入<br />
                    Hello, Eric！
                </pre>
                <br />
                <h4>6.3  引号内的引号处理</h4>
                ...
                <pre>
                    a = """Python is a widely used general-purpose, high level programming language. <br />
                    It was initially designed by Guido van Rossum in 1991 <br />
                    and developed by Python Software Foundation. <br />
                    It was mainly developed for emphasis on code readability, <br />
